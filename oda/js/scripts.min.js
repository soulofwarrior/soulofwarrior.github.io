...
$(function(){$("#menu, #alter-nav").on("click","a",function(e){e.preventDefault();var a=$(this).attr("href"),s=$(a).offset().top;$("body,html").animate({scrollTop:s},1100)}),$("#my-menu").mmenu({pageScroll:!0,navbars:[{position:"bottom",content:["<a class='fa fa-vk' href='https://vk.com/mdtropinin'></a>","<a class='fa fa-picture-o' href='#'></a>"]}],extensions:["theme-dark","pagedim-black","border-full","fx-menu-slide","fx-listitems-slide","shadow-panels"],navbar:{title:'<img src="img/logo.svg" alt="Разработка сайтов ODA">'},offCanvas:{position:"right"}}),$("#my-menu").data("mmenu").bind("open:finish",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".carousel-services").owlCarousel({loop:!0,items:1,smartSpeed:500,responsiveClass:!0,nav:!0,navText:['<i class="fa fa-chevron-left"></i>','<i class="fa fa-chevron-right"></i>'],dots:!1,autoheight:!0}),$(".logo img").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1}),$(window).on("scroll resize",function(){var e=$(window).scrollTop()/($(document).height()-$(window).height());$(".progress-bar").css({width:(100*e|0)+"%"}),$("progress")[0].value=e})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")}),$(window).scroll(function(){var e=$(this).scrollTop();$(".center-flex").css({transform:"translate(0%, "+e/6+"%"})}),$(document).ready(function(){$(".manufacture").animated("slideInLeft","slideOutLeft"),$(".way").animated("slideInRight","slideOutRight"),$(".r-flex").animated("slideInUp","slideInDown")});